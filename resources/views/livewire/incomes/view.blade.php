<div class="card max-w-4xl">
    ...
    <div class="p-4 mt-0 border-none text-gray-800 card-body">
        ...
        <div class="flex justify-between items-center mb-3">
            <h3 class="text-xl">View   income <span class="text-success">#{{ $user->id }}</span> details</h3>
        ...
        <div class="w-full">
            ...
            <div class="mb-3">
                ...
                <div class="w-53 px-3 py-3 bg-gray-100 text-gray-700 rounded">
                    ₵ {{ $user->inc_amount }}
           ...
           @if ($user->inc_description)
           <div  class="mb-3">
            <div class="mb-1">Descrption</div>
            <div class="w-full px-3 py-3 bg-gray-100 text-gray-700 rounded">
                {{ $user->inc_description }}
           ...
           @endif
            ...
            <div  class="mb-3">
                ...
                <div class="w-full px-3 py-3 bg-gray-100 text-gray-700">
