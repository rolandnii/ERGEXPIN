<div class="card max-w-4xl">
    ...
    <div class="p-4 mt-0 border-none text-gray-800 card-body">
        ...
        <div class="flex justify-between items-center mb-3">
            <h3 class="text-xl ">Delete expenses <span class="text-danger">#{{ $user->id }}</span> </h3>
        </div>
        @if (session('message'))
            <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 " role="alert" id="alert-con">
                <span class="font-medium">Expenses deleted!</span>
        ...
        <div class="text-gray-600">
            Would you like to delete this expenses?
        </div>
        @endif
